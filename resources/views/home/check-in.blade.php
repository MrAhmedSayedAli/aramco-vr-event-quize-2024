...
{{--
                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-lg text-center ajax-table">
                            <thead class="text-lg bg-gray-50">
                            <tr>
                                <th scope="col" class="px-6 py-3">#</th>
                                <th scope="col" class="px-6 py-3">Player Name</th>
                                <th scope="col" class="px-6 py-3">Code</th>
                                <th scope="col" class="px-6 py-3">Status</th>
{{--                                <th scope="col" class="px-6 py-3">Timer (Minutes)</th>--}}
        ...
        window.jQuery(function () {
            var table = window.jQuery('.ajax-table').DataTable({
                ...
                columns: [
                    ...
                    {className:'px-6 py-4 text-gray-500 dark:text-gray-400',data: 'state', name: 'state', orderable: false, searchable: false},
                    // {className:'px-6 py-4 text-gray-500 dark:text-gray-400',data: 'timer', name: 'timer', orderable: false, searchable: false},
